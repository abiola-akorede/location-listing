			...
			<form class="s12" method="POST" action="{{ route('register') }}">
				...
				<div class="row">
					<div class="input-field col s12">
						<input type="text" class="validate" value="{{ old('name') }}" name="name" placeholder="Name">
						{{-- <label>Name</label> --}}
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="input-field col s12">
						<input type="text" class="validate" name="category" value="Investor" readonly>
				...
				<div class="row">
					<div class="input-field col s12">
						<input type="password" class="validate" name="password_confirmation" placeholder="Confirm Password">
